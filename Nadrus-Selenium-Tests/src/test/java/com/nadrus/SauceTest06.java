...
public class SauceTest06 implements SauceOnDemandSessionIdProvider {
   /**
    ...
    public SauceTest06(String os, String version, String browser, String deviceName, String deviceOrientation, String screenResolution) {
        super();
        this.os = os;
    ...
    /**
     * #06 Majhool want to see all reviews in a specific course.
     * https://leantesting.com/en/projects/7121/test-plan/3068/edit
     * 
     * @throws Exception
     */
    @Test
    public void runTestID05() throws Exception {
        ...
        wd.get(Config.startURL+"/c/61");
        wd.findElement(By.cssSelector("div.text-center.mt-30 > a.btn.btn-default")).click();
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[1]/div")).size() != 0));
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[1]/div/div[2]/h1/a")).size() != 0));
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[1]/div/div[1]/a/img")).size() != 0));
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[2]/div")).size() != 0));
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[3]/div")).size() != 0));
        assertTrue((wd.findElements(By.xpath(".//*[@id='course-cards-vert']/li[4]/div")).size() != 0));
    }
    /**
